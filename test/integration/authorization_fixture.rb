...
module AuthorizationFixture
  ...
  def self.seed!(service)
    ...
    when "authorization-service"
      ...
      grant.call(:organization_readers, "organization.read.accounts", "Organization", :client_a)
      grant.call(:relationship_readers, "organization.read.accounts", "Organization", :client_a)
      grant.call(:relationship_readers, "account.read", "Account", :root_b)
    when "user-service"
    ...
    when "group-service"
      ...
      owners = {group_a: :root_a, group_b: :root_b, provider_admins_a: :provider_root_a, provider_admins_b: :cohort_b,
                ...
                organization_readers: :root_b, relationship_readers: :root_b}
      ...
      memberships = {reader_a: :group_a, reader_b: :group_b, admin_a: :provider_admins_a, admin_b: :provider_admins_b,
                     ...
                     group_reader_peer: :exact_group_readers, organization_reader: :organization_readers,
                     relationship_reader: :relationship_readers}
